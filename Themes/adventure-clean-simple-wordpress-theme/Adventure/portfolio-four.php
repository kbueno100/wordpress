			<div id="portfolio">
				...
				<div class="portfolio-container">
                    ...
                    <?php while ($wp_query->have_posts()) : $wp_query->the_post(); ?>
						...
						<li class="one-fourth <?php $cats = array_values(get_the_terms(get_the_id(), 'adv_portfolio_cat')); echo $cats[0]->slug; ?>">
						<p class="portfolio-img">
                        	...
                        	<?php } else { ?>
                        	<a href="<?php echo wp_get_attachment_url(get_post_thumbnail_id()); ?>" class="portfolio-item-preview" rel="prettyPhoto"><?php the_post_thumbnail('portfolio-four'); ?></a>
                        	<?php } ?>
                        </p>
