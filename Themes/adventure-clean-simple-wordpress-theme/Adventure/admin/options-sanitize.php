...
function of_sanitize_textarea($input) {
	global $allowedtags;
	$of_tags = $allowedtags;
	$of_tags['iframe'] = array( 'src' => array(), 'width' => array(), 'height' => array(), 'frameborder' => array(), 'allowfullscreen' => array());
	$of_tags['span'] = array( 'class' => array(), 'style' => array());
	$output = wp_kses( $input, $of_tags);
	return $output;
}
...
function of_recognized_font_faces() {
	...
	$fonts = $available_fonts['names'];
	ksort($fonts);
	return apply_filters( 'of_recognized_font_faces', $fonts );
}
